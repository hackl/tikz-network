...
\par\smallcaps{\url{https://github.com/hackl/tkz-network}}
...
\url{https://github.com/hackl/tkz-network}.  There, you'll find the actual version of the source code, a bug tracker, and the documentation.
...
\section{Add-ons}
\begin{itemize}
\item add igraph to tkz-network compiler (e.g. plot function)
\item add networkx to tkz-network compiler (e.g. plot function)
\item add QGIS to tkz-network compiler
\end{itemize}
